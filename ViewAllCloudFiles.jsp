...
<div class="main">
  ...
  <tr>
    <td width="140" height="32"><div align="center" class="style22">File Name </div></td>
      <td width="293"><div align="center" class="style22">Digital Sign </div></td>
    <td width="178"><div align="center" class="style22">Secret Key </div></td>
    <td width="115"><div align="center" class="style22">Rank </div></td>
    <td width="205"><div align="center" class="style22">Date & Time</div></td>
	<td width="205"><div align="center" class="style22">Access Authorization</div></td>
  </tr>
  ...
  <tr>
	...
	<td><div align="center" class="style31"><%=s4%></div></td>
	 ...
	 <td><div align="center" class="style31"><%=s5%></div></td>
	  ...
	  <% if(s7.equals("No"))
	  {%>
	  <td><div align="center" class="style31"><a href="Access_Control.jsp?id=<%=i%>">Give Access Control</a></div></td>
	  <%}
	  else
	  {%>
