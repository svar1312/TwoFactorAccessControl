...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style7">View Files and Generate Secret Key</h2>
          <p class="style7">&nbsp;</p>
          <table width="965" border="1" align="center">
  <tr>
    <td width="140" height="32"><div align="center" class="style10 style17"><strong>File Name </strong></div></td>
      <td width="293"><div align="center" class="style10 style17"><strong>Digital Sign </strong></div></td>
    <td width="178"><div align="center" class="style10 style17"><strong>Secret Key </strong></div></td>
    <td width="115"><div align="center" class="style10 style17"><strong>Rank </strong></div></td>
    <td width="205"><div align="center" class="style10 style17"><strong>Date & Time</strong></div></td>
	<td width="205"><div align="center" class="style10 style17"><strong>Access Authorization</strong></div></td>
  </tr>
...
<%
  ...
  <tr>
   ...
   <% if(s4.equals("No"))
	  {%>
	  <td><div align="center" class="style31"><a href="GenerateKey1.jsp?id=<%=i%>">Generate Secret Key</a></div></td>
	  <%}
	  else
	  {%>
