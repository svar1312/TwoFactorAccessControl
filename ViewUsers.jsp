...
.style14 {color: #0066CC; font-size: 18px; }
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style16">View All Users </h2>
          <div class="clr"></div>
          <div class="img">
            <div class="post_content">
              <h2 align="center">
                
                <table width="989" border="1" align="center">
                  <tr>
                    <td width="263" height="32"><div align="center" class="style14">User Image </div></td>
                    <td width="185"><div align="center" class="style14">User Name </div></td>
                    <td width="120"><div align="center" class="style14">DOB</div></td>
                    <td width="165"><div align="center" class="style14">E-Mail</div></td>
                    <td width="115"><div align="center" class="style14">Mobile</div></td>
                    <td width="101"><div align="center" class="style14">Location</div></td>
                  </tr>
                  <%
